...
public:
  ...
  : Node("listener")
  {
    ...
    auto callback =
      [this](const homework_msg::msg::WorkerMsg::SharedPtr msg) -> void
      {
        RCLCPP_INFO(this->get_logger(), "I heard: [%s, %d, %d]", msg->name.c_str(), msg->birth, msg->team); 
      };
    ...
    sub_ = create_subscription<homework_msg::msg::WorkerMsg>(topic_name, 10, callback);
  }

private:
  rclcpp::Subscription<homework_msg::msg::WorkerMsg>::SharedPtr sub_;
};
